...
root.configure(bg="#333333")  # Darker grey background
root.bind('<p>', lambda event: toggle_pause())
root.bind('<i>', lambda event: toggle_image_generation())
...
background_image = create_gradient_background(1400, 900, "#4A4A4A", "#666666")  # Darker grey gradient
...
dark_background = "#333333"  # Darker grey
light_text = "#FFFFFF"
dark_text = "#000000"

# Secondary colors for accents
accent_color_1 = "#333333"  
accent_color_2 = "#F78C6B"  # Orange accent

style.configure("TFrame", background=dark_background)
style.configure("TLabelframe", background=dark_background, foreground=light_text)
style.configure("TLabelframe.Label", background=dark_background, foreground=light_text)
style.configure("TLabel", background=dark_background, foreground=light_text)
style.configure("TButton", background=accent_color_1, foreground=light_text)
style.map("TButton", background=[("active", accent_color_2)])
style.configure("TEntry", fieldbackground="#4D4D4D", foreground=light_text)  # Slightly lighter background for entry fields
style.configure("TCombobox", fieldbackground="#4D4D4D", foreground=dark_text)
style.configure("Vertical.TScrollbar", background=accent_color_1, troughcolor=dark_background)


# Optional: Configure other widgets as needed
...
conversation_text = scrolledtext.ScrolledText(conversation_frame, wrap=tk.WORD, width=60, height=10, font=("Helvetica", 10), bg="#333333", fg="#ECF0F1")
...
agent_listbox = tk.Listbox(agent_frame, width=20, height=4, font=("Helvetica", 10), bg="#333333", fg="#ECF0F1")
...
audio_samples_list = tk.Listbox(audio_samples_frame, width=20, height=4, font=("Helvetica", 10), bg="#333333", fg="#ECF0F1")
